...
//         let block = block::add(None, "Hello, world!");
//         assert_eq!(
//             block.hash,
...
//         let first_block = block::add(None, "first block");
//         let second_block = block::add(Some(first_block.hash.clone()), "second block");
//         let third_block = block::add(Some(second_block.hash.clone()), "third block");
